...
import 'package:acha_eu/telas/TelaErro.dart';
...
class RouteGenerator {
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case "/listaservicos":
        return MaterialPageRoute(builder: (_) => ListaSericos(args));
      case "/detalhescontado":
        return MaterialPageRoute(builder: (_) => DetalhesContado(args));
      case "/contado":
        return MaterialPageRoute(builder: (_) => Contato());
      case "/adm":
        return MaterialPageRoute(builder: (_) => Adm());
      case "/detalhesAdm":
        return MaterialPageRoute(builder: (_) => DetalhesAdm(args));
      case "/listaSugestao":
        return MaterialPageRoute(builder: (_) => ListaSugestao());
      case "/detalhesugestao":
        return MaterialPageRoute(builder: (_) => DetalhesSugestao(args));
      case "/sugestaoUsuario":
        return MaterialPageRoute(builder: (_) => SugestaoUsuario(args));
      case "/listaSolicitacao":
        return MaterialPageRoute(builder: (_) => ListaSolicitacao());
      case "/listaPedidos":
        return MaterialPageRoute(builder: (_) => ListaPedidos(args));
      case "/detalhesPedidos":
        return MaterialPageRoute(builder: (_) => DetalhesPedido(args));
      case "/listaTrabalho":
        return MaterialPageRoute(builder: (_) => ListaTrabalhos());
      case "/propaganda":
        return MaterialPageRoute(builder: (_) => Propaganda());
      case "/pagamento":
        return MaterialPageRoute(builder: (_) => Pagamento());
        case "/erro":
        return MaterialPageRoute(builder: (_) => TelaErro());
