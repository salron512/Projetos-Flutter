...
class PerfilProduto extends StatefulWidget {
  String id;
  PerfilProduto(this.id);
  @override
  _PerfilProdutoState createState() => _PerfilProdutoState();
}

class _PerfilProdutoState extends State<PerfilProduto> {
            ...
            children: [
              Container(
                ...
                child: _urlImagem == null
                    ...
                    : CachedNetworkImage(imageUrl: _urlImagem),
              ),
              Padding(
                padding: EdgeInsets.all(10),
                child: Visibility(
