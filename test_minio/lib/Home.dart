...
class _HomeState extends State<Home> with SingleTickerProviderStateMixin {
  ...
  _consulta() async {
    ...
    print("teste:" +
        resultado["Mike Shinoda"]["albuns"]["Where'd You Go"]["titulo"]);
  }
          ...
          child: Column(
            children: [
              Card(
                ...
                child: ListTile(
                  title: Text("Album: " +
                      resultado["Serj tankian"]["albuns"]["Black Blooms"]
                      ["titulo"]),
                  subtitle:
                  Text("Artista: " + resultado["Serj tankian"]["nome"]),
                  onTap: () {
                    setState(() {
                      ...
                      ["Black Blooms"]["ano"]
                          .toString();
                      dados.duracao = resultado["Serj tankian"]["albuns"]
                      ["Black Blooms"]["duracao"]
                          .toString();
              ...
              Card(
                child: ListTile(
                  title: Text("Album: " +
                      resultado["Serj tankian"]["albuns"]["The Rough Dog"]
                      ["titulo"]),
                  ...
                  onTap: () {
                    setState(() {
                      ...
                      ["The Rough Dog"]["ano"]
                          .toString();
                      dados.duracao = resultado["Serj tankian"]["albuns"]
                      ["The Rough Dog"]["duracao"]
                          .toString();
                      dados.totalFaixas = resultado["Serj tankian"]
                      ["albuns"]["The Rough Dog"]["total-faixas"]
                          .toString();
                      dados.nome = resultado["Serj tankian"]["nome"];
              ...
              Card(
                child: ListTile(
                  ...
                  subtitle:
                  Text("Artista: " + resultado["Mike Shinoda"]["nome"]),
                  onTap: () {
                    setState(() {
                      ...
                      ["Post  Traumatic EP"]["ano"]
                          .toString();
                      dados.duracao = resultado["Mike Shinoda"]["albuns"]
                      ["Post  Traumatic EP"]["duracao"]
                          .toString();
              ...
              Card(
                child: ListTile(
                  title: Text("Album: " +
                      resultado["Mike Shinoda"]["albuns"]["Post Traumatic"]
                      ["titulo"]),
                  subtitle:
                  Text("Artista: " + resultado["Mike Shinoda"]["nome"]),
                  onTap: () {
                    setState(() {
                      ...
                      ["Post Traumatic"]["ano"]
                          .toString();
                      dados.duracao = resultado["Mike Shinoda"]["albuns"]
                      ["Post Traumatic"]["duracao"]
                          .toString();
                      dados.totalFaixas = resultado["Mike Shinoda"]
                      ["albuns"]["Post Traumatic"]["total-faixas"]
                          .toString();
                      dados.nome = resultado["Mike Shinoda"]["nome"];
              ...
              Card(
                child: ListTile(
                  title: Text("Album: " +
                      resultado["Mike Shinoda"]["albuns"]["The Rising Tied"]
                      ["titulo"]),
                  subtitle: Text("Artista: " +
                  ...
                  onTap: () {
                    setState(() {
                      ...
                      ["The Rising Tied"]["ano"]
                          .toString();
                      dados.duracao = resultado["Mike Shinoda"]["albuns"]
                      ["The Rising Tied"]["duracao"]
                          .toString();
                      dados.totalFaixas = resultado["Mike Shinoda"]
                      ["albuns"]["The Rising Tied"]["total-faixas"]
                          .toString();
                      dados.nome = resultado["Mike Shinoda"]["nome"];
              ...
              Card(
                child: ListTile(
                  title: Text("Album: " +
                      resultado["Mike Shinoda"]["albuns"]["Where'd You Go"]
                      ["titulo"]),
                  subtitle: Text("Artista: " +
                      resultado["Mike Shinoda"]["nome"].toString()),
                  onTap: () {
                    setState(() {
                      ...
                      ["Where'd You Go"]["ano"]
                          .toString();
                      dados.duracao = resultado["Mike Shinoda"]["albuns"]
                      ["Where'd You Go"]["duracao"]
                          .toString();
                      dados.totalFaixas = resultado["Mike Shinoda"]
                      ["albuns"]["Where'd You Go"]["total-faixas"]
                          .toString();
              ...
              Card(
                child: ListTile(
                  title: Text("Album: " +
                      resultado["Michel Teló"]["albuns"]["Bem Sertanejo"]
                      ["titulo"]),
                  subtitle:
                  Text("Artista: " + resultado["Michel Teló"]["nome"]),
                  onTap: () {
                    setState(() {
                      ...
                      ["Bem Sertanejo"]["duracao"]
                          .toString();
                      dados.totalFaixas = resultado["Michel Teló"]["albuns"]
                      ["Bem Sertanejo"]["total-faixas"]
                          .toString();
              ...
              Card(
                child: ListTile(
                  title: Text("Album: " +
                      resultado["Michel Teló"]["albuns"]
                      ["Bem Sertanejo - O Show (Ao Vivo)"]["titulo"]),
                  subtitle:
                  Text("Artista: " + resultado["Michel Teló"]["nome"]),
                  onTap: () {
                    setState(() {
                      ...
                      ["Bem Sertanejo - O Show (Ao Vivo)"]["titulo"];
                      dados.ano = resultado["Michel Teló"]["albuns"]
                      ["Bem Sertanejo - O Show (Ao Vivo)"]["ano"]
                          .toString();
                      dados.duracao = resultado["Michel Teló"]["albuns"]
              ...
              Card(
                child: ListTile(
                  title: Text("Album: " +
                      resultado["Guns N' Roses"]["albuns"]["Greatest Hits"]
                      ["titulo"]),
                  subtitle: Text(
                  ...
                  onTap: () {
                    setState(() {
                      ...
                      ["Greatest Hits"]["ano"]
                          .toString();
                      dados.duracao = resultado["Guns N' Roses"]["albuns"]
                      ["Greatest Hits"]["duracao"]
                          .toString();
                      dados.totalFaixas = resultado["Guns N' Roses"]
                      ["albuns"]["Greatest Hits"]["total-faixas"]
                          .toString();
